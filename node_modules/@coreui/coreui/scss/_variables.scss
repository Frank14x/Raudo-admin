...
$sidebar-nav-link-hover-bg:           #000!default;
$sidebar-nav-link-hover-icon-color:   #fff !default;
$sidebar-nav-link-hover-borders:      0 !default;

$sidebar-nav-link-active-color:       $gray-800 !default;
$sidebar-nav-link-active-bg:          #FFF !default;
$sidebar-nav-link-active-icon-color:  $gray-800 !default;
